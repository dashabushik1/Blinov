...
public class Tomato extends Vegetable {
    public final static double CALORIFIC_VAL_1GR = 0.2; // калорийность в 1 гр
    private String fruitKind; // вид
    ...
    public String toString() {
        return color + " tomato, weight: " + weight + " gram, fruit sort: " + fruitKind + ", calorific value: "
                + calorificValue + " kcal.";
    }
}
